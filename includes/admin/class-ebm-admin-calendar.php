	...
	public static function render() {
		...
		foreach ( $bookings as $booking ) {
			...
			$events_by_day[ $day_key ][] = array(
				...
				'url'      => admin_url( 'admin.php?page=ebm-bookings' ),
			);
		}
		...
		$weekdays = array( __( 'Sun', 'electrical-booking-manager' ), __( 'Mon', 'electrical-booking-manager' ), __( 'Tue', 'electrical-booking-manager' ), __( 'Wed', 'electrical-booking-manager' ), __( 'Thu', 'electrical-booking-manager' ), __( 'Fri', 'electrical-booking-manager' ), __( 'Sat', 'electrical-booking-manager' ) );
		?>
			...
			<div class="ebm-calendar-card">
				...
				<?php if ( ! EBM_Google::connected() ) : ?>
					<div class="notice notice-info inline" style="margin:16px 24px;">
						<p><?php esc_html_e( 'Google Calendar is not connected yet. Plugin bookings will still show here.', 'electrical-booking-manager' ); ?> <a href="<?php echo esc_url( admin_url( 'admin.php?page=ebm-settings' ) ); ?>"><?php esc_html_e( 'Connect it in settings.', 'electrical-booking-manager' ); ?></a></p>
					</div>
				<?php endif; ?>

				<?php if ( $google_error ) : ?>
					<div class="notice notice-warning inline" style="margin:16px 24px;"><p><?php echo esc_html( $google_error ); ?></p></div>
				<?php endif; ?>
